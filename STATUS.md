...
nodes. Planner-worker-reviewer, summary/artifact compaction, automatic memory
...
- Planner-worker-reviewer child sessions and general graph-node adapters beyond
  the four live built-in semantics.
