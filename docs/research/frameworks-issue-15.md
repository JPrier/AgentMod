...
|---|---|---|---|---|---|---|---|---|---|
| LangGraph / Platform | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Does not qualify |
| Amazon Strands | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Does not qualify |
| Temporal | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Does not qualify |
| Restate | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Does not qualify |
| Mastra | Unverified | Unverified | Pass | Unverified | Unverified | Unverified | Unverified | Unverified | Does not qualify |
| Inngest | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Unverified | Does not qualify |
...
The initial review overclaimed several Fail and Pass verdicts. This revision treats missing proof as Unverified. A framework may implement context ownership in application-level extensions; that possibility is not itself a failure. Fail is reserved for an explicit contradiction in the supported interface. Likewise, durable checkpoints are not assumed to be complete boundary audit logs, child workflows are not assumed to be context branches, deployment/versioning is not assumed to be live next-step reconfiguration, and cancellation is not assumed to kill arbitrary processes.
...
C1 is Unverified in this desk review: graph state is controllable, but the exact provider request context and all harness-owned context are not exposed as an arbitrary editable state through the normal graph extension API. C2–C5 have substantial support through nodes, checkpoints, interrupts, and replay/time-travel. C6 is Unverified in this desk review: graph/application deployment changes are deployment operations, while changing model/tools/context policy live for an existing running session without restart is not a supported general capability. C7 is Unverified for guaranteed process-level kill of arbitrary tool subprocesses and provider requests. C8 is Unverified: the reviewed material does not prove whether a supported extension can supply all required behavior without core rework.
...
Temporal’s event history and workflow state support C3, while child workflows support C5 and Signals/Updates/versioning support controlled workflow changes. C1 is Unverified: Temporal is a durable workflow engine; arbitrary LLM prompt/context assembly is application code inside workflow/activity boundaries, not a universally inspectable and mutable runtime context. C7 is Pass for workflow cancellation semantics, but this does not guarantee undo of external effects. C8 is Unverified because the reviewed material does not establish whether an ordinary integration can supply the complete context contract. C2/C4 remain Unverified at the exact model/tool boundary granularity.
...
These support durable workflow execution, independent events, concurrency controls, and cancellation. C1 is Unverified: Inngest steps do not document an agent-specific editable context window; context assembly remains application/model integration code. C5/C6 are Pass at the workflow/event deployment level (parallel functions and evolving deployed code), but this is not proof of mutating an already-running session’s agent context and configuration at the next boundary. C7 is Pass for function cancellation within documented semantics, with external side-effect limits. C8 is Unverified because the reviewed material does not establish that the central context ownership requirement is outside the extension model.
